...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('add');?>">添加会员</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php if($val['status'] > 0): ?>正常
                    <?php elseif($val['status'] == 0): ?>未激活
                    <?php elseif($val['status'] < 0): ?>封禁<?php endif; ?></td>
                <td align="center">
