...
#menu-list ul { padding: 5px 0; margin:0; list-style-type: none; color:#335B64;}
#menu-list li { padding-left:16px; line-height:18px; cursor:hand; cursor:pointer;}
#main-div a:visited, #menu-list a:link, #menu-list a:hover { color:#335B64; text-decoration:none;}
#menu-list a:active { color:#EB8A3D;}
.explode { background:url(http://admin.shop.cn/Public/images/menu_minus.gif) no-repeat 0px 5px; font-weight:bold;}
.collapse { background:url(http://admin.shop.cn/Public/images/menu_plus.gif) no-repeat 0px 5px; font-weight:bold;}
.menu-item { background:url(http://admin.shop.cn/Public/images/menu_arrow.gif) no-repeat 0px 5px; font-weight:normal;}
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php if(is_array($menus)): foreach($menus as $key=>$top): if(($top["parent_id"]) == "0"): ?><li class="explode" name="menu">
                    <?php echo ($top["name"]); ?>
                        <ul>
                            <?php if(is_array($menus)): foreach($menus as $key=>$son): if(($son['parent_id']) == $top['id']): ?><li class="menu-item"><a href="<?php echo U($son['path']);?>" target="main-frame"><?php echo ($son["name"]); ?></a></li><?php endif; endforeach; endif; ?>
                        </ul>
