...
.explode { background:url(http://admin.shop.cn/Public/images/menu_minus.gif) no-repeat 0px 3px; font-weight:bold;}
.collapse { background:url(http://admin.shop.cn/Public/images/menu_plus.gif) no-repeat 0px 3px; font-weight:bold;}
.menu-item { background:url(http://admin.shop.cn/Public/images/menu_arrow.gif) no-repeat 0px 3px; font-weight:normal;}
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="http://admin.shop.cn/Public/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            订单管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Order/index');?>" target="main-frame">订单列表</a></li>
            ...
            <li class="explode" name="menu">
                ...
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Article/add');?>" target="main-frame">添加文章</a></li>
                </ul>
            </li>
            <li class="explode" name="menu">
            会员管理
            ...
            <li class="explode" name="menu">
                角色权限管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Permission/index');?>" target="main-frame">权限列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Permission/add');?>" target="main-frame">添加权限</a></li>
                    <li class="menu-item"><a href="<?php echo U('Role/index');?>" target="main-frame">角色列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Role/add');?>" target="main-frame">添加角色</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script type="text/javascript" src="http://admin.shop.cn/Public/js/global.js"></script>
<script type="text/javascript" src="http://admin.shop.cn/Public/js/utils.js"></script>
<script type="text/javascript" src="http://admin.shop.cn/Public/js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? 'http://admin.shop.cn/Public/images/menu_minus.gif' : 'http://admin.shop.cn/Public/images/menu_plus.gif';
