...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('add');?>">添加广告</a></span>
...
<form method="post" action="" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($banners)): $i = 0; $__LIST__ = $banners;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                <td class="first-cell"><?php echo ($val["id"]); ?></td>
                <td align="center"><?php echo ($val["title"]); ?></td>
                <td class="first-cell"><?php echo ($val["sort"]); ?></td>
                <td align="center"><img src="http://admin.shop.cn/Public/images/<?php echo ($val["is_show"]); ?>.gif" /></td>
                <td align="center"><?php echo (date("Y-m-d h:i:s",$val["start_time"])); ?></td>
                <td align="center"><?php echo (date("Y-m-d h:i:s",$val["end_time"])); ?></td>
                <td align="center">
                <a href="<?php echo U('edit',array('id'=>$val['id']));?>" title="编辑">编辑</a> |
                <a href="<?php echo U('remove',array('id'=>$val['id']));?>" title="编辑">删除</a>
                </td>
