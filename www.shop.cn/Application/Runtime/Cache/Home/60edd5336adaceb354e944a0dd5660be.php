...
<head>
	...
	<script type="text/javascript" src="http://www.shop.cn/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="http://www.shop.cn/Public/js/header.js"></script>
	<script type="text/javascript" src="http://www.shop.cn/Public/js/home.js"></script>
</head>
<body>
		<!-- 顶部导航 start -->
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					...
					<li>我的订单</li>
					<li class="line">|</li>
					<li><a href="<?php echo U('Member/logout');?>">退出登录</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="http://www.shop.cn/Public/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
