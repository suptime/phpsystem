...
<head>
	...
	<link rel="stylesheet" href="http://www.shop.cn/Public/css/goods.css" type="text/css">
	<link rel="stylesheet" href="http://www.shop.cn/Public/css/jqzoom.css" type="text/css">

	<script type="text/javascript" src="http://www.shop.cn/Public/js/goods.js"></script>
	<script type="text/javascript" src="http://www.shop.cn/Public/js/jqzoom-core.js"></script>
	<!-- jqzoom 效果 -->
...
<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > <?php echo ($row["name"]); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="http://www.shop.cn/Public/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://www.shop.cn/Public/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://www.shop.cn/Public/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://www.shop.cn/Public/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="http://www.shop.cn/Public/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<?php if(is_array($gallery)): $i = 0; $__LIST__ = array_slice($gallery,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo C('IMG_PATH'); echo ($v); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
								<img src="<?php echo C('IMG_PATH'); echo ($v); ?>" alt="" />               <!-- 第一幅图片的中图 -->
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($gallery)): $k = 0; $__LIST__ = $gallery;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($k % 2 );++$k;?><li <?php if($k == 1): ?>class="cur"<?php endif; ?>>
										<a <?php if($k == 1): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.shop.cn/<?php echo ($pic); ?>',largeimage: 'http://admin.shop.cn/<?php echo ($pic); ?>'}"><img src="<?php echo C('IMG_PATH'); echo ($pic); ?>"></a>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								...
								<li><span>商品编号：</span><?php echo ($row["sn"]); ?></li>
								<li><span>品牌：</span><?php echo ($row["brand"]); ?></li>
								<li><span>上架时间：</span><?php echo (date('Y-m-d',$row["inputtime"])); ?></li>
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://www.shop.cn/Public/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://www.shop.cn/Public/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://www.shop.cn/Public/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
